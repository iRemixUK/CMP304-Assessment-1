...
void ACMP304Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &ACMP304Character::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &ACMP304Character::TouchStopped);

	// VR headset functionality
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ACMP304Character::OnResetVR);
}


void ACMP304Character::OnResetVR()
{
	// If CMP304 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in CMP304.Build.cs is not automatically propagated
...
void ACMP304Character::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void ACMP304Character::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
